      ...
      <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
          ...
          {place.photos?.[0] && (
            <div>
              <img
                ...
                className="aspect-square object-cove cursor-pointer"
        ...
        <div className="grid">
          {place.photos?.[1] && (
            <img
              onClick={() => setShowAllPhotos(true)}
              className="aspect-square object-cover cursor-pointe"
          ...
          <div className="overflow-hidden">
            {place.photos?.[2] && (
              <img
                onClick={() => setShowAllPhotos(true)}
                className="aspect-square object-cover relative top-2 cursor-pointe"
