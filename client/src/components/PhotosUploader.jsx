    ...
    <>
      <div className="flex gap-2">
        <input
          type="text"
          value={photoLink}
          onChange={(ev) => addPhotoWithLink(setPhotoLink(ev.target.value))}
          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className=" cursor-pointer absolute bottom-2 right-1 text-white bg-black bg-opacity-50 rounded-2xl  py-2 px-3"
              >
                <svg
